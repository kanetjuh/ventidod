...
return message.reply("Sorry, you don't have permissions to use this! :no_entry_sign: ");
  ...
  .setTitle("Announcements created by: " + `${message.author.tag}`)
  .setColor("#36393E")
  .setDescription(alertTekst)
  .setFooter("Announcement created by: " + message.author.tag)
  .setTimestamp()
message.reply("I have created your announcement in the channel: " + "<#" + sconfig.announceChannel + ">!")
